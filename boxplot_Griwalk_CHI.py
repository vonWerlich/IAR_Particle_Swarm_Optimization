...
nomes = [
   "5 dim. (ϕ = 4.05)", "5 dim. (ϕ = 4.1)", "5 dim. (ϕ = 4.5)", "5 dim. (ϕ = 5.5)",
   "10 dim. (ϕ = 4.05)", "10 dim. (ϕ = 4.1)", "10 dim. (ϕ = 4.5)", "10 dim. (ϕ = 5.5)"
]
...
ax.set_title("Comparação entre Diferentes Fatores de Constrição para Griewank")
plt.tight_layout()
