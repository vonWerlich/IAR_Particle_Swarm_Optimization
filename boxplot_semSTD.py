...
arquivo1 = "boxplot_1_semSTD.txt"
arquivo2 = "boxplot_2_semSTD.txt"
...
nomes = [
   "5 dim. (GRI/INER)", "5 dim. (GRI/CON)",
    "5 dim. (ACK/INER)", "5 dim. (ACK/CON)",
    "10 dim. (GRI/INER)", "10 dim. (GRI/CON)",
    "10 dim. (ACK/INER)", "10 dim. (ACK/CON)"
]
...
ax.set_title("Comparação de Desempenho entre Configurações de PSO")
plt.tight_layout()
