...
# Parâmetros
arquivo = "boxplot_1.txt"      # nome do arquivo com todos os dados
...
# Personalização
nomes = ["5 dim.", "10 dim.", "30 dim."]
ax.set_xticklabels(nomes)
ax.set_ylabel("Resultado Final do Algoritmo")
ax.set_title("Comparação Inicial entre Standard, Inertia e Constriction")
